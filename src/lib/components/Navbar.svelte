...
<header class="sticky h-16 flex itens-center top-0 z-10 bg-(--palette-accent) backdrop-blur-lg bg-blend-multiply bg-[radial-gradient(var(--palette-accent-tint)_2px,transparent_0)] bg-size-[12px_12px]">
